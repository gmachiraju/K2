...
def top_model_continuous_iid(metric_str, model_cache_dir, linearized_cache_dir, return_all=False):
    """
...
def top_model_preds(metric_str, results_cache_dir, model_cache_dir, return_all=False):
    """
